        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    console.log((0, viem_1.parseEther)(ethAmount));
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    hash = _a.sent();
                    console.log("Withdraw transaction hash: ".concat(hash));
                    return [3 /*break*/, 6];
                case 5:
                    connectButton.innerText = "Please install MetaMask";
                    _a.label = 6;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    balance = _a.sent();
                    console.log("Balance: ".concat((0, viem_1.formatEther)(balance), " Ether"));
                    _a.label = 2;
